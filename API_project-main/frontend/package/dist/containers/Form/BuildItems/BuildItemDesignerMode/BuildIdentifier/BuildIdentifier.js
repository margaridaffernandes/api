...
import Identifier from "../../../../../components/FormDesigner/Datatypes/Identifier/Identifier";
...
const buildIdentifierFormDesigner = (item, itemIndex, pathArray, setFieldValue, values, isAny, itemSection, initialValues, handleFormOrder, formOrder) => {
...
export { buildIdentifierFormDesigner };