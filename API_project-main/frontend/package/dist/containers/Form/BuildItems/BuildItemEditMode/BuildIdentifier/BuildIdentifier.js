...
const BuildIdentifierEditMode = (item, itemIndex, pathArray, setFieldValue, values, errors, touched, setFieldTouched, isAny, cardinalityObject, sectionValidation, initialValues, validationSchema, itemSection, multipleSections, professionalTasks, order) => {
    ...
    if (isVisible && ruleVisibility) {
      if (isEditable) {
        ...
        return /*#__PURE__*/React.createElement(Identifier, {
          ...
          onIdentifierChange: setFieldValue,
          label: label,
          path: pathArray.join("."),
          pathLabel: pathLabel,
...
export default BuildIdentifierEditMode;