...
import Proportion from "../../../../../components/Datatypes/Proportion/Proportion";
...
const BuildProportionEditMode = (item, itemIndex, pathArray, setFieldValue, values, errors, touched, setFieldTouched, isAny, cardinalityObject, sectionValidation, initialValues, validationSchema, itemSection, multipleSections, professionalTasks, order) => {
...
export default BuildProportionEditMode;